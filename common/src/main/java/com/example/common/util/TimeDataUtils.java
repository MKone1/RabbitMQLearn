...
public final class TimeDataUtils {
    ...
    public static int getMonthCount(Date sDate, Date eDate) {
        String sDateStr = TimeDataUtils.formatDateTimetoString(sDate, "MM");
        String eDateStr = TimeDataUtils.formatDateTimetoString(eDate, "MM");
    ...
    public static int getYearCount(Date sDate, Date eDate) {
        String sDateStr = TimeDataUtils.formatDateTimetoString(sDate, "yyyy");
        String eDateStr = TimeDataUtils.formatDateTimetoString(eDate, "yyyy");
    ...
    public static Date getDayNextMonth(Date date) {
        String yearStr = TimeDataUtils.formatDateTimetoString(date, "yyyy");
        String monthStr = TimeDataUtils.formatDateTimetoString(date, "MM");
        String dayStr = TimeDataUtils.formatDateTimetoString(date, "dd");
        ...
        try {
            date = TimeDataUtils.parseToDate(dateStr);
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//
//        String startDay = TimeDataUtils.format(startDate, "dd");
//        String endtDay = TimeDataUtils.format(endDate, "dd");
//        String value = "";
//        if (startDay.equals(endtDay)) {
//            value = TimeDataUtils.format(startDate, " HH:mm");
//        } else {
...
//            value = TimeDataUtils.format(startDate, "yyyy-MM-dd HH:mm");
//        } else {
//            value = otherDiff(startDate, endDate);
//        }
//        return value;
